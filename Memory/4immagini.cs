...
namespace Memory
{
    //codice per la form con 4 immagini
    public partial class Form2 : Form
    {
        ...
        Image[,] arrimmagine = new Image[2, 4];//da 8 perchè le immagini sono 2
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            ...
            arrimmagine[0, 3] = Imm3;
            arrimmagine[1, 3] = Imm3;
            //int i = 0;
            //for (int y = 0; y < 3; y++)
            //{
        ...
        {
            azzeramento();
            for(int i = 0; i < 8; i++)//per mescolarlo più volte
            {
                int numerox1 = rd.Next(0, 2);//prende i numeri random per la x1
                int numerox2 = rd.Next(0, 2);//prende i numeri random per la x2
                int numeroy1 = rd.Next(0, 4);//prende i numeri random per la y1
                int numeroy2 = rd.Next(0, 4);//prende i numeri random per la y2
